...
CREATE TABLE `eb_system_log` (
  ...
  KEY `add_time` (`add_time`) USING BTREE,
  KEY `type` (`type`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='管理员操作记录表';

-- ----------------------------
--  Records of `eb_system_log`
-- ----------------------------
BEGIN;
INSERT INTO `eb_system_log` VALUES ('1', '1', 'admin', 'admin/system.systemcleardata/orderdata/', '未知', 'GET', '123.139.93.171', 'system', '1555659637', '0'), ('2', '1', 'admin', 'admin/system.systemcleardata/userrelevantdata/', '未知', 'GET', '123.139.93.171', 'system', '1555659640', '0');
COMMIT;

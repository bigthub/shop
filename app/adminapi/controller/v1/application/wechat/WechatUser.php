...

{
    ...
    public function edit_user_tag($openid)
    {
        ...
        return create_form('编辑用户标签', $f, Url::buildUrl('/app/wechat/user_tag/' . $openid), 'PUT');
    }
    ...
    public function edit_user_group($openid)
    {
        ...
        return create_form('编辑用户标签', $f, Url::buildUrl('/app/wechat/user_group/' . $openid), 'PUT');
    }
...
//        if(!$groupId) return app('json')->fail('请选择用户分组!');
    ...
    public function create_tag()
    {
        ...
        return create_form('添加标签', $f, Url::buildUrl('/app/wechat/tag'), 'POST');
    }
    ...
    {
        $f = [Form::input('name', '标签名称')];
        return create_form('编辑标签', $f, Url::buildUrl('/app/wechat/tag/' . $id), 'PUT');
    }
